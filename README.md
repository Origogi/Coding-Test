...
- [Maximum Subarray](https://leetcode.com/explore/interview/card/top-interview-questions-easy/97/dynamic-programming/566/)
  ...
  - [Code](src/leetcode/kotlin/dp/MaximumSubarray.kt)

- [House Robber](https://leetcode.com/explore/interview/card/top-interview-questions-easy/97/dynamic-programming/576/)
  - [Code](src/leetcode/kotlin/dp/HouseRobber.kt)

### Exercise

- [Palindrome Number](https://leetcode.com/problems/palindrome-number/) `#Easy`
  - [Code](src/leetcode/kotlin/exercise/PalindromeNumber.kt)
- [ZigZag Conversion](https://leetcode.com/problems/zigzag-conversion/) `#Medium`

  - [Code](src/leetcode/kotlin/exercise/ZigZag.kt)

- [Valid Parentheses](https://leetcode.com/problems/valid-parentheses/) `#Easy`

  - [Code](src/leetcode/kotlin/exercise/ValidParentheses.kt)

- [Generate Parentheses](https://leetcode.com/problems/generate-parentheses/) `#Medium`
  - [Code](src/leetcode/kotlin/exercise/GenerateParentheses.kt)
- [Remove Duplicates from Sorted Array](https://leetcode.com/problems/remove-duplicates-from-sorted-array/) `#Easy`

  - [Code](src/leetcode/kotlin/exercise/RemoveDuplicates.kt)

- [Remove Element](https://leetcode.com/problems/remove-element/) `#Easy`

  - [Code](src/leetcode/kotlin/exercise/RemoveElement.kt)

- [Permutations](https://leetcode.com/problems/permutations/) `#Medium`

  - [Code](src/leetcode/kotlin/exercise/Permutations.kt)

- [Combination Sum](https://leetcode.com/problems/combination-sum/) `#Medium`

  - [Code](src/leetcode/kotlin/exercise/CombinationSum.kt)

- [Minimum Path Sum](https://leetcode.com/problems/minimum-path-sum/) `#Medium`

  - [Code](src/leetcode/kotlin/exercise/MinimumPathSum.kt)

- [Search Insert Position](https://leetcode.com/problems/search-insert-position/) `#Easy`
  - [Code](src/leetcode/kotlin/exercise/SearchInsertPosition.kt)
